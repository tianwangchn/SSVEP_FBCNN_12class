...
from data_process_10_band_UD import data_batch_FFT_one_tester_real_UD,data_batch_FFT_one_tester_abs_UD,data_batch_FFT_one_tester_complex_UD
...
def cnn_model(input_shape,decay):
    ...
    #input1
    input1_x = Conv2D(filters=16, kernel_size = (3,3),use_bias=False,padding='valid',kernel_regularizer=l2(l=decay),kernel_initializer=initializers.RandomNormal(mean=0.0, stddev=0.01, seed=None))(input1)
    ...
    input1_x = Conv2D(filters=16, kernel_size = (1,20),use_bias=False,padding='valid',kernel_regularizer=l2(l=decay),kernel_initializer=initializers.RandomNormal(mean=0.0, stddev=0.01, seed=None))(input1_x)
    input1_x = BatchNormalization()(input1_x)
    input1_x = Activation('relu')(input1_x)
    input1_x = Dropout(0.25)(input1_x)
    ...
    input1_x_2 = Dense(units=16, activation='sigmoid', use_bias=False,kernel_regularizer=l2(l=decay))(input1_x_2)
    input1_x = Multiply()([input1_x,input1_x_2])
    #input2
    input2_x = Conv2D(filters=16, kernel_size = (3,3),use_bias=False,padding='valid',kernel_regularizer=l2(l=decay),kernel_initializer=initializers.RandomNormal(mean=0.0, stddev=0.01, seed=None))(input2)
    ...
    # input2_x_1 = Dense(units=2,activation='relu',use_bias=False,kernel_regularizer=l2(l=decay))(input2_x_1)
    ...
    input2_x = Conv2D(filters=16, kernel_size = (1,20),use_bias=False,padding='valid',kernel_regularizer=l2(l=decay),kernel_initializer=initializers.RandomNormal(mean=0.0, stddev=0.01, seed=None))(input2_x)
    input2_x = BatchNormalization()(input2_x)
    input2_x = Activation('relu')(input2_x)
    input2_x = Dropout(0.25)(input2_x)
    ...
    input2_x_2 = Dense(units=16, activation='sigmoid', use_bias=False,kernel_regularizer=l2(l=decay))(input2_x_2)
    input2_x = Multiply()([input2_x,input2_x_2])
    #input3
    input3_x = Conv2D(filters=16, kernel_size = (3,3),use_bias=False,padding='valid',kernel_regularizer=l2(l=decay),kernel_initializer=initializers.RandomNormal(mean=0.0, stddev=0.01, seed=None))(input3)
    ...
    # input3_x_1 = Dense(units=2,activation='relu',use_bias=False,kernel_regularizer=l2(l=decay))(input3_x_1)
    ...
    input3_x = Conv2D(filters=16, kernel_size = (1,20),use_bias=False,padding='valid',kernel_regularizer=l2(l=decay),kernel_initializer=initializers.RandomNormal(mean=0.0, stddev=0.01, seed=None))(input3_x)
    input3_x = BatchNormalization()(input3_x)
    input3_x = Activation('relu')(input3_x)
    input3_x = Dropout(0.25)(input3_x)
    ...
    input1_x = Dense(units=72, activation='relu', use_bias=False,kernel_regularizer=l2(l=decay),kernel_initializer=initializers.RandomNormal(mean=0.0, stddev=0.01, seed=None))(input1_x)
    input2_x = Dense(units=72, activation='relu', use_bias=False,kernel_regularizer=l2(l=decay),kernel_initializer=initializers.RandomNormal(mean=0.0, stddev=0.01, seed=None))(input2_x)
    input3_x = Dense(units=72, activation='relu', use_bias=False,kernel_regularizer=l2(l=decay),kernel_initializer=initializers.RandomNormal(mean=0.0, stddev=0.01, seed=None))(input3_x)
...
if __name__ == "__main__":
    ...
    for i in range(len(all_trailers)):
        ...
        for train_index, test_index in kf.split(train_datas_1):
            ...
            EEG_model = cnn_model((10,402,1),decay = 0.001) #complex: 11,402,1 or abs: 11,201,1
            # EEG_model.summary()
            ...
            # EEG_model.fit([x_tr1,x_tr2,x_tr3], label_tr, epochs=epoch, batch_size=batch_size, verbose=1,validation_data=([x_ts1,x_ts2,x_ts3],label_ts))
