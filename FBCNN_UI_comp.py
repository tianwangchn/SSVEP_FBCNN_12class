...
from data_process_10_band_UI import data_batch_FFT_one_tester_real_UI,data_batch_FFT_one_tester_abs_UI,data_batch_FFT_one_tester_complex_UI
...
if __name__ == "__main__":
    ...
    for i in range(len(all_trailers)):
        ...
        for j in range(10): #每个trailers 10次取平均值
            ...
            # EEG_model.fit([train_datas_1,train_datas_2,train_datas_3], train_labels_one_hot, epochs=epoch, batch_size=batch_size, verbose=1,validation_data=([test_datas_1,test_datas_2,test_datas_3], test_labels_one_hot))
