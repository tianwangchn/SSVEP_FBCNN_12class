...
if __name__ == "__main__":
    ...
    for i in range(len(all_trailers)):
        ...
        train_datas_1,train_datas_2,train_datas_3,train_labels,test_datas_1,test_datas_2,test_datas_3,test_labels = data_batch_FFT_one_tester_abs_UI(all_trailers[i],time_length=1)
